...
const SignUpPage = () => {
  ...
  return (
    ...
    <section className='w-[100vw] h-[100vh] flex justify-center items-center'>
        ...
        {!isSignedUp && <div className='flex flex-col items-start justify-start gap-2 w-[70vw] sm:w-[50vw] md:w-[40vw] lg:w-[28vw] h-fit border border-secondary-border bg-white rounded-lg shadow-lg px-3 py-3' onKeyDown={(e)=>{
            if(e.key === 'Enter'){
                HandleSignUp()
            }
        }}>
            ...
            <input type='text' placeholder='Name' className='w-full py-1 font-medium text-lg shadow-xs border border-secondary-border rounded-md px-3 outline-none' value={name} onChange={(e)=>{
            ...
            <input type='text' placeholder='Email' className='w-full py-1 font-medium text-lg shadow-xs border border-secondary-border rounded-md px-3 outline-none'  value={email} onChange={(e)=>{
            ...
            <div className='w-full flex flex-col h-fit items-end justify-center'>
                <input type={showPassword} placeholder='Password' className='w-full py-1 font-medium text-lg shadow-xs border border-secondary-border rounded-md px-3 select-none outline-none'  value={password} onChange={(e)=>{
            ...
            <div className='w-full flex flex-col gap-2 justify-between items-center'>
                <button className='bg-white w-full py-1 border border-secondary-border rounded-lg hover:bg-gray-200 cursor-pointer shadow-2xs transition-all duration-150'>Continue With Google</button>
                <button className='bg-white w-full py-1 border border-secondary-border rounded-lg hover:bg-gray-200 cursor-pointerr shadow-2xs transition-all duration-150 cursor-pointer'>Continue With GitHub</button>
            </div>
        ...
        {isSignedUp && <div className='w-[70vw] h-fit sm:w-[50vw] md:w-[40vw] flex flex-col items-center gap-3 justify-center lg:w-[58vw] border border-secondary-border bg-white rounded-lg shadow-lg px-3  py-12'>
