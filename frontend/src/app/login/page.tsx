    ...
    <section className='w-[100vw] h-[100vh] flex justify-center items-center'>
        ...
        <div className='flex flex-col items-start justify-start gap-2 w-[70vw] sm:w-[50vw] md:w-[40vw] lg:w-[28vw] h-fit border border-primary-border bg-white rounded-lg shadow-lg px-3 py-3'>
            ...
            <div className='w-full flex flex-col gap-2 justify-between items-center'>
                ...
                <button className='bg-white w-full py-1 border border-primary-border rounded-lg hover:bg-gray-200 cursor-pointerr shadow-2xs transition-all duration-150'>Continue With GitHub</button>
            </div>
            ...
            <div className='w-full flex flex-col gap-2 justify-between items-center pb-4'>
                ...
                <span className='text-sm'>Forgot Password?
                    <Link href={'/reset-password'} className='text-blue-600 hover:underline'>Reset Password</Link>
                </span>
            </div>
        </div>
    </section>
